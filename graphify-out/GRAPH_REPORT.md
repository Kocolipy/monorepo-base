...
## Corpus Check
- 139 files · ~68,254 words
- Verdict: corpus is large enough that graph structure adds value.
- Unclassified: 14 file(s) not represented in the graph (top: (none) 9, .example 1, .properties 1)

## Summary
- 1220 nodes · 2661 edges · 87 communities (64 shown, 23 thin omitted)
- Extraction: 86% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 362 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `fa2da474`
...
Cohesion: 0.05
Nodes (30): Backend API Contract (OpenAPI 3.1), X-XSRF-TOKEN Header Parameter, deleteSession operation, getCount operation, getCurrentUser operation, getHealth operation, getSession operation, incrementCount operation (+22 more)
...
### Community 5 - "api.ts"
Cohesion: 0.11
Nodes (23): decodeUser(), getCurrentUser(), login(), logout(), apiFetchMock, TEST_LOGIN, useAuthState(), SessionRequest (+15 more)

### Community 6 - "Workflow"
Cohesion: 0.08
Nodes (22): Fix Recommendation Patterns, Report Template, Trend Comparison (`--history`), Cosmic Ray / Python, Custom, mutmut / Python, PIT / JVM, Stryker.NET / .NET (+14 more)

### Community 7 - "Shared Playwright storageState for Auth"
Cohesion: 0.40
...
Cohesion: 0.08
Nodes (25): 03 — The runtime configuration surface has no module at all — Strong (count grew again), 04 — The Counter slice is seven modules over a two-field row — Worth exploring (contrast sharpened again), 06 — A template whose identity has no seam — Speculative (unchanged), 09 — The login path must remember to count its own attempts — Worth exploring (unchanged), 12 — The account listing row is authored five times — Strong (new), 13 — Schema evolution has no module — Strong (new), 14 — Account status is enforced only at authentication — Worth exploring (new), Architecture review — deepening opportunities (+17 more)
...
Cohesion: 0.12
Nodes (11): AuthUser, AuthContext, AuthContextState, AuthContextValue, apiFetchMock, auth, apiFetchMock, auth (+3 more)
...
### Community 37 - "SpaFrontendTests"
Cohesion: 0.19
Nodes (9): Override, SpaErrorViewResolver, SpaFrontendTests, org.springframework.boot.webmvc.autoconfigure.error.ErrorViewResolver, org.springframework.http.HttpStatus, org.springframework.stereotype.Component, org.springframework.test.web.servlet.MockMvc, org.springframework.web.servlet.ModelAndView (+1 more)
...
### Community 56 - ".save"
Cohesion: 0.17
Nodes (3): AccountAdministrationService, AccountAdministrationServiceTests, org.springframework.transaction.annotation.Transactional

### Community 57 - "AuthController.java"
Cohesion: 0.06
Nodes (38): 10 — The role vocabulary is authored on both sides of the contract — Speculative (authors grew), 11 — Two administrative namespaces, one of them dead — Strong (new), LoginService, UnknownAccountException, UnsafeAccountChangeException, AuthController, LoginRequest, UserResponse (+30 more)
...
Cohesion: 0.15
Nodes (13): assertthat, assertthatthrownby, AccountRole, ADMIN, USER, Override, MutableClock, duration (+5 more)

### Community 63 - "SecurityConfig.java"
Cohesion: 0.11
Nodes (16): authenticationentrypoint, bcryptpasswordencoder, changesessionidauthenticationstrategy, cookiecsrftokenrepository, daoauthenticationprovider, httpmethod, httpsessionsecuritycontextrepository, org.springframework.security.config.annotation.web.builders.HttpSecurity (+8 more)
...
### Community 65 - "AccountEntity"
Cohesion: 0.06
Nodes (27): AccountJpaRepository, AccountPersistenceAdapter, Override, AccountEntity, UserCounterEntity, UserCounterJpaRepository, Override, UserCounterPersistenceAdapter (+19 more)

### Community 66 - "ArchitectureTest.java"
Cohesion: 0.12
Nodes (16): classes, configuration, controller, entity, entitymanager, generalcodingrules, importoption, noclasses (+8 more)

### Community 67 - "Account"
Cohesion: 0.24
Nodes (4): Account, AccountRepository, InMemoryAccountRepository, Override

### Community 70 - "AccountService"
Cohesion: 0.29
Nodes (9): accountseed, 08 — Seeded accounts are identified by position, not by role — Strong (regressed), Assessment: was the work done?, What the new code adds to the board, AccountSeed, AccountService, AccountSeedConfig, org.springframework.boot.ApplicationRunner (+1 more)
...
### Community 72 - "LockoutPolicy"
Cohesion: 0.29
Nodes (5): LoginAttemptService, LoginLockoutConfig, LockoutPolicy, clock, value

### Community 73 - "components.json"
Cohesion: 0.18
Nodes (10): aliases, components, hooks, lib, ui, iconLibrary, rsc, $schema (+2 more)

### Community 74 - ".findByUsername"
Cohesion: 0.22
...
### Community 77 - "Frontend Testing Guide"
Cohesion: 0.25
...
Cohesion: 0.14
Nodes (13): assertthatcode, assertthatnoexception, authentication, authenticationmanager, badcredentialsexception, chronounit, defaultcookieserializer, inmemoryuserdetailsmanager (+5 more)
...
### Community 84 - "Frontend Architecture Doc"
Cohesion: 0.29
...
- **Why does `AccountSummary` connect `AccountSummary` to `.save`, `AuthController.java`, `AccountRole`?**
  _High betweenness centrality (0.133) - this node is a cross-community bridge._
- **Why does `13 — Schema evolution has no module — Strong (new)` connect `AccountSummary` to `accounts.tsx`, `AccountService`?**
